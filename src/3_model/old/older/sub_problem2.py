...
class UnitCommitmentModel:
    ...
    def _define_sets(self, m, year=2016):
        """Define sets"""
    ...
    def _define_parameters(self, m, year=2016):
    ...
    def _define_variables(self, m, year=2016):
    ...
    @staticmethod
    def _define_expressions(m, year=2016):
    ...
    #
    #     # Parameters
    #     m = m._define_parameters(m)
    #
    #     # Variables
    #     m = m._define_variables(m)
    #
    #     # Expressions
    #     m = m._define_expressions(m)
    #
    #     # Constraints
    #     # -----------
